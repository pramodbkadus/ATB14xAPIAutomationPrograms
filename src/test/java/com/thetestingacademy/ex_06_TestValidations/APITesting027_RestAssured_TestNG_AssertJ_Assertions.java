...
public class APITesting027_RestAssured_TestNG_AssertJ_Assertions {
    ...
    public void test_createBooking_POST() {
        ...
        // Rest Assured -> import org.hamcrest.Matchers; -> Matchers.equalTo()
        ...
        Assert.assertEquals(lastName, "Kadus");
        ...
        assertThat(lastName).isNotEmpty().isNotBlank().isNotNull().isEqualTo("Kadus");
    }
}
